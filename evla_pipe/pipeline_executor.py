...
class PipelineExecutor:
    ...
    def execute_pipeline(
        ...
        if self.verbose:
            print(
                f":: EVLA scripted pipeline v{__version_str__} with modern state management"
            )
        ...
        for i in range(start_index, stop_index + 1):
            ...
            try:
                ...
                save_pipeline_checkpoint(
                    step_name, context, "failed", duration, error_msg
                )
        ...
        if self.verbose:
            ...
            print(
                f":: Pipeline progress: {progress['completed_steps']}/{progress['total_steps']} steps completed"
            )
    ...
    def _exec_flag_baddeformatters(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        from evla_pipe.EVLA_pipe_flag_baddeformatters import (
    ...
    def _exec_checkflag_semiFinal(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        from evla_pipe.EVLA_pipe_checkflag_semiFinal import (
...
def execute_pipeline_with_state_management(
    sdm_name: str,
    skip_hanning: bool = False,
    enable_polarization: bool = False,
    enable_plots: bool = True,
