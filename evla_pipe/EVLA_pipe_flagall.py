def EVLA_pipe_flagall(pipeline_context):
    """
    Apply deterministic flagging to the data using flagdata list mode.
...
def task_logprint(msg):
    ...
    task_logprint(f"QA2 score: {format_qa_status(QA2_flagall)}")
    time_list = runtiming("flagall", "end")

    # Update context and return
    pipeline_context["QA2_flagall"] = QA2_flagall
    pipeline_context["frac_flagged_on_source1"] = frac_flagged_on_source1
