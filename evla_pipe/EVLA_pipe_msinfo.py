...
logprint ("Plotting antenna positions (linear)", logfileout='logs/msinfo.log')
...
logprint ("Antenna positions plot (linear) plotants.png", logfileout='logs/msinfo.log')

logprint ("Plotting antenna positions (logarithmic)", logfileout='logs/msinfo.log')
