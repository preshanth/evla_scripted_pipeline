...
logprint(
    "Final calibration tables moved to " + caltables_dir,
    logfileout="logs/filecollect.log",
)
...
try:
    ...
    logprint(
        "writing pickle file: " + pickle_filename, logfileout="logs/completion.log"
    )
    try:
    ...
    logprint(
        "Completed on " + gmt_time + " with pipeline SVN revision " + svnrevision,
