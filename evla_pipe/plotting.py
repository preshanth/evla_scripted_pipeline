...
try:
    ...
    warnings.warn(f"casaplotms not available: {e}")
    PLOTMS_AVAILABLE = False
    
    def plotms(*args, **kwargs):
        """Fallback plotms function when casaplotms is not available."""
        warnings.warn("plotms called but casaplotms not available - skipping plot")
        return None
...
try:
    ...
    warnings.warn("matplotlib not available - some plotting features disabled")
...
try:
    ...
    warnings.warn("numpy not available - some plotting features disabled")
...
def create_plotms_plot(vis: str, xaxis: str, yaxis: str, **kwargs) -> bool:
    ...
    **kwargs
    ...
    if not PLOTMS_AVAILABLE:
        warnings.warn("plotms not available - skipping plot")
        return False
    ...
    try:
        ...
        warnings.warn(f"plotms failed: {e}")
        return False


def plot_calibration_table(caltable: str, xaxis: str, yaxis: str, 
                          plotfile: Optional[str] = None, **kwargs) -> bool:
    """
    ...
    **kwargs
    ...
    """
    if not PLOTMS_AVAILABLE:
        warnings.warn("plotms not available - skipping calibration table plot")
        return False
    ...
    try:
        ...
        warnings.warn(f"Calibration table plot failed: {e}")
        return False


def plot_visibility_data(vis: str, field: str, spw: str, 
                        xaxis: str = 'time', yaxis: str = 'amp',
                        plotfile: Optional[str] = None, **kwargs) -> bool:
    """
    ...
    **kwargs
    ...
    """
    if not PLOTMS_AVAILABLE:
        warnings.warn("plotms not available - skipping visibility plot")
        return False
    ...
    try:
        ...
        warnings.warn(f"Visibility plot failed: {e}")
        return False


def plot_bandpass_solutions(caltable: str, plotfile: Optional[str] = None, **kwargs) -> bool:
    """
...
def plot_gain_solutions(caltable: str, plotfile: Optional[str] = None, **kwargs) -> bool:
    """
    Plot gain solutions.
...
def plot_phase_solutions(caltable: str, plotfile: Optional[str] = None, **kwargs) -> bool:
    """
...
def plot_flux_density_fit(frequencies: List[float], flux_densities: List[float], 
                         fit_coeffs: List[float], plotfile: Optional[str] = None) -> bool:
    """
    ...
    if not MATPLOTLIB_AVAILABLE or not NUMPY_AVAILABLE:
        warnings.warn("matplotlib or numpy not available - skipping flux density plot")
        return False
    ...
    try:
        ...
        warnings.warn(f"Flux density plot failed: {e}")
        return False


def create_summary_plots(vis: str, output_dir: str = "plots", 
                        enable_plots: bool = True) -> Dict[str, bool]:
    """
